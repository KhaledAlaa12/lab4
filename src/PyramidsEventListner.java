...
public class PyramidsEventListner implements GLEventListener {
    ...
    public void display(GLAutoDrawable glAutoDrawable) {
        ...
        task2(glAutoDrawable.getGL());
        task3(glAutoDrawable.getGL());
    }
